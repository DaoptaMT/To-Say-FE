...
//         {text: 'Đăng xuất', onPress: () => router.replace('/LoginScreen')},
//       ]
//     );
//   };
...
// ✅ Thêm interface cho SettingItem
...
const SettingsScreen: React.FC = () => {
  ...
  // ✅ Component SettingItem với optional props
...
const styles = StyleSheet.create({
  ...
  logoutButton: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingVertical: 15 },
  logoutText: { fontSize: 16, color: '#FF6B6B', marginLeft: 15, fontWeight: 'bold' },
});
